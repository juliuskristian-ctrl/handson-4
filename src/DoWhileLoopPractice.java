...
public class DoWhileLoopPractice {
    public static void main(String[] args) {
        ...
        do {
            System.out.println("Attempt " + (++attempts) + ": Simulating invalid input.");
            // Simulate receiving valid input after a few tries
            if (attempts == 2) {
                inputValue = 7;
            }
        ...
        do {
            ...
            // Simulating an attempt to enter the password
            attemptCount++;
